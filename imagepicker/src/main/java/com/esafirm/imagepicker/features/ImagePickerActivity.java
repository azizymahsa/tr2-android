...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    private TextView emptyTextView,tvMenu,tvTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMenu.setTypeface(Typeface.createFromAsset(getAssets(), "icomoon.ttf"));
        tvMenu.setText(getString(R.string.ef__icon));
        tvTitle.setTypeface(Typeface.createFromAsset(getAssets(), "iran_sans_normal.ttf"));
        tvMenu.setOnClickListener(view -> {finish(); });
    }
