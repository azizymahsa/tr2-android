...
public class ScreenShot
{
    ...
    public ScreenShot(View v, final Activity activity_)
    {
        ...
        picName = dateFormat.format(cal.getTime()) + ".jpeg";
        ...
        new TedPermission(activity)
                .setPermissionListener(new PermissionListener()
                {
                    ...
                    public void onPermissionGranted()
                    {
                        ...
                        final File myDir = new File(Environment.getExternalStorageDirectory().toString() + "/eniac/", picName);
    ...
    public static File getFile(View view)
    {
        ...
        return new File(Environment.getExternalStorageDirectory().toString() + "/eniac/", picName);
