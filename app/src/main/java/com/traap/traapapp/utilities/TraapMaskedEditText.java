...
public class TraapMaskedEditText extends com.rengwuxian.materialedittext.MaterialEditText
{
    ...
    public TraapMaskedEditText(Context context) {
        this(context, "");
    }

    public TraapMaskedEditText(Context context, String mask) {
        this(context, mask, PLACEHOLDER);
    }

    public TraapMaskedEditText(Context context, String mask, char placeholder) {
        this(context, null, mask, placeholder);
    }

    public TraapMaskedEditText(Context context, AttributeSet attr) {
        this(context, attr, "");
    }

    public TraapMaskedEditText(Context context, AttributeSet attr, String mask) {
        this(context, attr, "", PLACEHOLDER);
    }

    public TraapMaskedEditText(Context context, AttributeSet attr, @NonNull String mask, char placeholder) {
        super(context, attr);
        setPrimaryColor(R.color.black);
        setUnderlineColor(R.color.black);
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (updating || TraapMaskedEditText.this.mask.length() == 0)
                    return;
