...
public class CompationsWinAdapter extends RecyclerView.Adapter<CompationsWinAdapter.ViewHolder>
{
    ...
    {
        view = mInflater.inflate(R.layout.list_row_compations_win, parent, false);
