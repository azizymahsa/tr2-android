 ...
 */
public class DetailPackAdapter_old extends RecyclerView.Adapter<DetailPackAdapter_old.ViewHolder>
{
    ...
    public DetailPackAdapter_old(final List<Detail> data, GetPackInAdapter getPackInAdapter, Integer operatorType)
    {
        this.data = data;
