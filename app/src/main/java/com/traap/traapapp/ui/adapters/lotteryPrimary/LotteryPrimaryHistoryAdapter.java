...
public class LotteryPrimaryHistoryAdapter extends RecyclerView.Adapter<LotteryPrimaryHistoryAdapter.ViewHolder>
{
    private OnLotteryItemClickListener listener;
    private Context mContext;
    private List<PredictTabModel> list;

    public LotteryPrimaryHistoryAdapter(Context mContext, List<PredictTabModel> list, OnLotteryItemClickListener listener)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.adapter_lottery_primary_history, null);
...
//        }
    ...
    {
        private TextView tvTitle, tvSubTitle, tvStatus;
