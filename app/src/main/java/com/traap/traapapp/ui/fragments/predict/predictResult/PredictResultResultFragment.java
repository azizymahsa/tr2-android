...
public class PredictResultResultFragment extends BaseFragment implements OnServiceStatus<WebServiceClass<GetPredictResponse>>,
        OnAnimationEndListener, CountDownTimerView, PredictResultActionView
{
    ...
    public PredictResultResultFragment()
    {
    }
                             ...
                             Bundle savedInstanceState)
    {
        ...
        rootView = inflater.inflate(R.layout.fragment_predict_result, container, false);
...
//        APIlib.getInstance().setActiveAnyChartView(chartViewColumn);
    ...
    private void sendPredict()
    {
        ...
        SingletonService.getInstance().sendPredictService().sendPredictService(request, new OnServiceStatus<WebServiceClass<Object>>()
        {
            ...
            {
                btnSendPredict.revertAnimation(PredictResultResultFragment.this);
