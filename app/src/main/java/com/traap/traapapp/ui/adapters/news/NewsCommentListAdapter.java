...
public class NewsCommentListAdapter extends RecyclerView.Adapter<NewsCommentListAdapter.ViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        switch (item.getRated())
        {
            ...
            case 1:
            {
                holder.imgLike.setColorFilter(mContext.getResources().getColor(R.color.imageLikedTintColor));
                holder.imgDislike.setColorFilter(mContext.getResources().getColor(R.color.textHint));
                break;
            }
            case -1:
            {
                holder.imgLike.setColorFilter(mContext.getResources().getColor(R.color.textHint));
                holder.imgDislike.setColorFilter(mContext.getResources().getColor(R.color.imageDislikedTintColor));
                break;
            }
//            default:
//            {
        ...
        holder.imgLike.setOnClickListener(v ->
        {
            switch (item.getRated())
            {
                case 0:
                {
                    ...
                    item.setLikeCount(newLike);

                    holder.tvLikeCounter.setTextColor((mContext.getResources().getColor(R.color.imageLikedTintColor)));
                    holder.tvDislikeCounter.setTextColor((mContext.getResources().getColor(R.color.textHint)));
                ...
                case 1:
                {
                    ...
                    holder.tvLikeCounter.setTextColor((mContext.getResources().getColor(R.color.textHint)));
                    holder.tvDislikeCounter.setTextColor((mContext.getResources().getColor(R.color.textHint)));
                ...
                case -1:
                {
                    ...
                    item.setLikeCount(newLike);
                    item.setDislikeCount(newDislike);
        ...
        holder.imgDislike.setOnClickListener(v ->
        {
            switch (item.getRated())
            {
                case 0:
                {
                    ...
                    holder.tvLikeCounter.setTextColor((mContext.getResources().getColor(R.color.textHint)));
                    holder.tvDislikeCounter.setTextColor((mContext.getResources().getColor(R.color.imageDislikedTintColor)));
