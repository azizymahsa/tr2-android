...
public class EvaluationPlayerItemListAdapter extends RecyclerView.Adapter<EvaluationPlayerItemListAdapter.ViewHolder>
{
    ...
    public EvaluationPlayerItemListAdapter(Context context, Integer matchId, List<Column> columnList, float itemWidth, OnPlayerItemClick listener)
    {
    ...
    {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_evaluation_player_item_list, null);
