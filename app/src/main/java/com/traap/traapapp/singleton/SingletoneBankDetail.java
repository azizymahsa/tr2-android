...
public class SingletoneBankDetail
{
    ...
    public void addToArray()
    {
        ...
        list.add(new SingletoneBankDetail.BankDetail("003825", "دیبا", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("003725", "دیبا", R.drawable.logo_dey, "#af9852"));
        //==============================================================================================================================================
        list.add(new SingletoneBankDetail.BankDetail("639599", "بانک قوامین", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("606373", "قرض الحسنه مهر", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("606256", "موسسه اعتباري عسكريه", R.drawable.logo_dey, "#af9852"));
        //list.add(new SingletoneBankDetail.BankDetail("639346", "بانک سینا", R.drawable.logo_dey,"#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("636795", "بانك مركزي", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("628157", "بانك توسعه", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("581874", "بانک مشترک ايران و ونزوئلا", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("581672", "پرداخت الكترونيك", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("507677", "موسسه اعتباري نور", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("505801", "موسسه اعتباري كوثر", R.drawable.logo_dey, "#af9852"));
        list.add(new SingletoneBankDetail.BankDetail("186214", "بانك آينده", R.drawable.logo_dey, "#af9852"));
        ...
        list.add(new SingletoneBankDetail.BankDetail("636949", "بانک حکمت ایرانیان", R.drawable.logo_dey, "#af9852"));
