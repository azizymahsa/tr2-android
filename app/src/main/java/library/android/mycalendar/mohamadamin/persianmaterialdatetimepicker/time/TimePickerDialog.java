...
import library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.TypefaceHelper;
import library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.Utils;
...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCancelButton.setTypeface(library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.TypefaceHelper.get(getDialog().getContext(),"IRANSansMobile"));
...
//        int darkDoneBackground = R.drawable.mdtp_done_background_color_dark;
    ...
    private boolean addKeyIfLegal(int keyCode) {
        ...
        library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.Utils.tryAccessibilityAnnounce(mTimePicker, String.format("%d", val));
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            mMinuteSpaceView.setText(library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.utils.LanguageUtils.getPersianNumbers(minuteStr));
