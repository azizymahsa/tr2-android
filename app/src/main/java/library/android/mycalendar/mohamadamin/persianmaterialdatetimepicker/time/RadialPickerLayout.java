...
package library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.time;
...
import library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.utils.LanguageUtils;
import library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.HapticFeedbackController;
...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.time.TimePickerDialog.HOUR_INDEX;
    private static final int MINUTE_INDEX = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.time.TimePickerDialog.MINUTE_INDEX;
    private static final int AMPM_INDEX = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.time.TimePickerDialog.AMPM_INDEX;
    private static final int ENABLE_PICKER_INDEX = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.time.TimePickerDialog.ENABLE_PICKER_INDEX;
    private static final int AM = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.time.TimePickerDialog.AM;
    private static final int PM = TimePickerDialog.PM;

    private int mLastValueSelected;

    private library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.HapticFeedbackController mHapticFeedbackController;
    ...
    **/
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED) {
            ...
            String timeString = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.utils.LanguageUtils.getPersianNumbers(
