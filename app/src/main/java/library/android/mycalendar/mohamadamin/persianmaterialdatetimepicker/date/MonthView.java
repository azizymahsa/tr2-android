...
//        mMonthTitlePaint.setTypeface(Typeface.create(mMonthTitleTypeface, Typeface.BOLD));
        ...
        mMonthNumPaint.setTypeface(library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.TypefaceHelper.get(getContext(), "IRANSansMobile_Light"));
    }
    ...
    protected class MonthViewTouchHelper extends ExploreByTouchHelper
    {
        ...
        protected CharSequence getItemDescription(int day) {
            ...
            final String date = library.android.mycalendar.mohamadamin.persianmaterialdatetimepicker.utils.LanguageUtils.getPersianNumbers(mTempCalendar.getPersianLongDate());
