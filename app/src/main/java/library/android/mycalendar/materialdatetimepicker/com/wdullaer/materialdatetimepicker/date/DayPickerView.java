...
public abstract class DayPickerView extends ListView implements OnScrollListener,
    ...
    public void onScroll(
        ...
        library.android.mycalendar.materialdatetimepicker.com.wdullaer.materialdatetimepicker.date.MonthView child = (library.android.mycalendar.materialdatetimepicker.com.wdullaer.materialdatetimepicker.date.MonthView) view.getChildAt(0);
        if (child == null) {
            return;
        }
    ...
    private MonthAdapter.CalendarDay findAccessibilityFocus() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child instanceof library.android.mycalendar.materialdatetimepicker.com.wdullaer.materialdatetimepicker.date.MonthView) {
                final MonthAdapter.CalendarDay focus = ((library.android.mycalendar.materialdatetimepicker.com.wdullaer.materialdatetimepicker.date.MonthView) child).getAccessibilityFocus();
                if (focus != null) {
                    if (Build.VERSION.SDK_INT == Build.VERSION_CODES.JELLY_BEAN_MR1) {
                        // Clear focus to avoid ListView bug in Jelly Bean MR1.
                        ((library.android.mycalendar.materialdatetimepicker.com.wdullaer.materialdatetimepicker.date.MonthView) child).clearAccessibilityFocus();
                    }
                    return focus;
                }
            }
