...
//                        paymentInstance);
    ...
    public void compeletInfoFragmentData(Integer selectPositionId, Integer count, Integer amountForPay,Integer amountOneTicket, List<Integer> ticketIdList,Integer stadiumId)
    {
