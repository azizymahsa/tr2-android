package ir.traap.tractor.android.apiServices.model.tourism.hotel.hotelPayment.request;
...
//    private String ReservationChar;
    ...
    protected GdsHotelPaymentRequest(Parcel in)
    {
        UserId = in.readInt();
    ...
    public static final Creator<GdsHotelPaymentRequest> CREATOR = new Creator<GdsHotelPaymentRequest>()
    {
        @Override
        public GdsHotelPaymentRequest createFromParcel(Parcel in)
        {
            return new GdsHotelPaymentRequest(in);
        }

        @Override
        public GdsHotelPaymentRequest[] newArray(int size)
        {
            return new GdsHotelPaymentRequest[size];
        }
    };
