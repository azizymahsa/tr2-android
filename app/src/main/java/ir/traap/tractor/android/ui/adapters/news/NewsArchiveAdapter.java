...
public class NewsArchiveAdapter extends RecyclerView.Adapter<NewsArchiveAdapter.ViewHolder>
{
    ...
    private List<NewsArchiveListById> list;

    public NewsArchiveAdapter(Context mContext, List<NewsArchiveListById> list)
    {
    ...
    {
        NewsArchiveListById item = list.get(position);
    ...
    {
        public void onSliderItemClick(Integer id, NewsArchiveListById newsArchiveContent, Integer position);
    }
