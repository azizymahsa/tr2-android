...
public class PaymentFragment extends BaseFragment implements OnAnimationEndListener,
        View.OnClickListener, OnServiceStatus<WebServiceClass<PaymentPrintPosResponse>>
{
    ...
    public static PaymentFragment newInstance(MainActionView mainView)
    {
    ...
    public void onResume()
    {
        ...
        etQR.setText("");
        btnConfirm.revertAnimation(PaymentFragment.this);
